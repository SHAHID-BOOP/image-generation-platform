...
-- CreateEnum
CREATE TYPE "public"."EthinicityEnum" AS ENUM ('White', 'Black', 'AsianAmerican', 'EastAsian', 'SouthEastAsian', 'SouthAsian', 'MiddleEastern', 'Pacific', 'Hispanic');
...
CREATE TABLE "public"."Model" (
    ...
    "ethinicuty" "public"."EthinicityEnum" NOT NULL,
